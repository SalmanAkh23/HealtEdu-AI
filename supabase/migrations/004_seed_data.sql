...
insert into public.quiz_questions (quiz_id, question, options, correct_answer, explanation, order_index) values
  ...
  ('qz-sleep-1-000000-0000-0000-0000-000000000002', 'During which sleep stage does most memory consolidation and dreaming occur?', '["Stage 1 (NREM 1)","Stage 2 (NREM 2)","Stage 3 (Deep Sleep)","REM Sleep"]', 3, 'REM (Rapid Eye Movement) sleep is associated with dreaming and plays an important role in memory consolidation and emotional processing.', 3),
